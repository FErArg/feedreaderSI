...
include('../inc/email/SMTPconfig.php');
include('../inc/email/SMTPClass.php');
/*
echo "<pre>";
print_r($_POST);
echo "</pre>";
*/
$to = filter_var($_POST['para'], FILTER_SANITIZE_STRING);
$subject = filter_var($_POST['asunto'], FILTER_SANITIZE_STRING);
$body = filter_var($_POST['contenido'], FILTER_SANITIZE_STRING);
$rssId = filter_var($_POST['rssId'], FILTER_SANITIZE_STRING);
$from = $SmtpUser;

$body = "Enlace enviado desde mi feedreaderSI ".$version."\n\n".$body;
