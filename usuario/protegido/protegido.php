...
if( isset($_SESSION['rss2']) OR isset($_SESSION['importante']) ){
...
$campos = 'id, titulo, fecha, enlace, visitas, importante';
$tabla1 = 'feeds';
$columna1 = 'usuarioId';
...
//----------------------------------------------------------------------
// PAGINACION
$page_name = "?w=protegido";
$t = mysql_query("SELECT count(*) cnt FROM feeds where usuarioId = '$usuarioId' AND eliminado = '0' AND protegido = '1' ");
...
WHERE usuarioId = '$usuarioId' AND eliminado = '0' AND protegido = '1' ORDER BY fecha DESC LIMIT $set_limit, $limit ");
