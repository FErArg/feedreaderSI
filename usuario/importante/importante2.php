...
$importante = filter_var($_GET['im'], FILTER_SANITIZE_STRING);
...
if( $importante == '0' OR $importante == '' OR $importante == ' ' OR empty($importante) ){
	// marca como importante
	mysql_query("UPDATE feeds SET importante='1' WHERE id='$id'");
	echo mysql_error();
} else{
	mysql_query("UPDATE feeds SET importante='0' WHERE id='$id'");
	echo mysql_error();
}
