...
foreach( $fechas as $value ){
	...
	$query1 = mysql_query("SELECT COUNT(id) FROM feeds WHERE usuarioId = '$usuarioId' AND protegido ='1' AND eliminado ='0' AND fecha BETWEEN '$fechaI' AND '$fechaF'");
...
$chart->setTitle("Protegidos por D&iacute;a");
